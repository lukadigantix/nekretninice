...
const detailRows = (p: Property) => [
  { label: "Tip objekta", value: p.tags[0]?.label === "Exklusiv" ? "Ekskluzivni objekat" : "Stambena nekretnina" },
  { label: "Status", value: "Na prodaju" },
  { label: "Sobe", value: `${p.rooms} sob.` },
  { label: "Stambena površina", value: `${p.sqm} m²` },
  { label: "Sprat", value: p.floor },
  { label: "Godina izgradnje", value: p.yearBuilt },
  { label: "ID objekta", value: p.id.slice(0, 10).toUpperCase() },
];
    ...
    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-8 flex flex-col gap-3 rounded-2xl border border-brand-border bg-[#F7F9FB] p-6">
          <p className="font-display text-base font-bold text-brand-dark">Zainteresovani?</p>
          <p className="font-sans text-xs text-brand-muted leading-relaxed">
            Kontaktirajte nas za diskretno razgledanje ili više informacija.
          </p>
          ...
          <a
            href={`mailto:nekretninice@gmail.com?subject=Zahtjev za razgledanje`}
